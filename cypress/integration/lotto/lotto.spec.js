describe('로또 미션 Cypress', () => {
  ...
  context.only('STEP2 - 결과 확인 Test', () => {
    const mockData = {
      typedPrice: 5000,
      duplicatedNumbers: [[1, 3, 12, 5, 4, 2], 10],
      overRangeNumbers: [[47, 1, 12, 30, 23, 2], 10],
      emptyRangeNumbers: [[1, 12, 30, 23, 2, 10], 14],
    ...
    // TODO: 결과를 확인 할 수 없는 입력 테스트 코드 추가
    context('2. 결과를 확인 할 수 있는 입력', () => {
      it('당첨 번호 입력 테스트', () => {
